	...
	<div class="w1000">
		...
		<div class="cont">
			...
			<div class="repair_con mt10">
				<div class="repair_title">
					<ul>
						...
						<li class="current cur" onclick="go('${pageContext.request.contextPath }/teacher/courseware/${courseId }')">课件</li>
						<li  onclick="go('${pageContext.request.contextPath }/teacher/homework/${courseId }')">作业</li>											
					</ul>
					<span class="back">
          ...
          <div class="repair_main">      
        	...
        	<pg:pager url="${pageContext.request.contextPath}/teacher/courseware/${courseId }" items="${pageModel.totalRecord}"
