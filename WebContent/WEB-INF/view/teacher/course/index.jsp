    ...
    <jsp:include page="../../common/navigation_menu.jsp" /> 
     ...
     <div class="cont">
    	<div class="current-position" >
            <span class="font14" > 当前位置：<a  href="${pageContext.request.contextPath }/teacher">首页</a> &gt;&gt; 课程</span>   
        </div>
    	...
    	<div class="repair_title">
          ...
          <form id="form" action="${pageContext.request.contextPath}/teacher/course" method="post">
          <div class="repair_main">
        	...
        	<pg:pager url="${pageContext.request.contextPath}/teacher/course" items="${pageModel.totalRecord}"
		...
		<%-- 					<span class="page-skip" style="margin-right: 0px;">共${pageNumber }页，去第<input style="width:25px; height:20px;border: 1px solid #ababab; border-radius:4px; text-align:center" id="pageNum" type="text" />页</span> 
             ...
             <div class="repair_info">
             	<ul>
                	...
                	<li><a href="javascript:void(0);" onclick="goWithUrl('${pageContext.request.contextPath}/teacher/course/add')">课程添加</a></li>                               	                	                
                </ul>
             </div> 
