		...
		<div class="cont">
			...
			<div class="repair_con mt10">
				<div class="repair_title">
					<ul>
					    <li onclick="go('${pageContext.request.contextPath }/teacher/course/detail/${courseId }')">课程详情</li>						
						<li onclick="go('${pageContext.request.contextPath }/teacher/courseware/${courseId }')">课件</li>
						<li class="current cur" onclick="go('${pageContext.request.contextPath }/teacher/homework/${courseId }')">作业</li>		
					</ul>
					<span class="back">
          ...
          <div class="repair_main">      
            ...
            <div class="repair_search">                          
              ...
              <c:forEach items="${pageModel.pageData }" var="homework" varStatus="status">
               ...
               <td class="f_2"><fmt:formatDate value="${homework.createTime }"
                    	...
                    	<td class="f_2">  
                    	        <a href="javascript:void(0);"onclick="goWithUrl('${pageContext.request.contextPath }/teacher/homework/add/${courseId}?id=${homework.homeworkId}');"  title="编辑"><img src="${pageContext.request.contextPath }/images/edit.png" width="16" height="16" style="margin-right: 10px;" alt=""/></a>
                            	...
                            	<a href="javascript:void(0);" onclick="goWithUrl('${pageContext.request.contextPath }/teacher/homework/detail/${homework.homeworkId}');">查看</a>                                                        	                                                                                   
        	...
        	<pg:pager url="${pageContext.request.contextPath}/teacher/homework/${courseId }" items="${pageModel.totalRecord}"
             ...
             <div class="repair_info">
             	<ul>             	
                	<li><a href="javascript:void(0);" onclick="goWithUrl('${pageContext.request.contextPath }/teacher/homework/add/${courseId}');"">添加作业</a></li>                               	                	                
                </ul>
             </div> 
