		...
		<div class="cont">
			...
			<div class="repair_con mt10">
				<div class="repair_title">
					<ul>
					    <li  onclick="go('${pageContext.request.contextPath }/homework/detail/${homeworkId }')">作业详情</li>												
						<li  class="current cur"  onclick="go('${pageContext.request.contextPath }/homework/submit/${homeworkId }')">作业批改</li>								
					</ul>
					<span class="back">
          ...
          <div class="repair_main">      
        	...
        	<pg:pager url="${pageContext.request.contextPath}/homework/submit/${homeworkId }" items="${pageModel.totalRecord}"
