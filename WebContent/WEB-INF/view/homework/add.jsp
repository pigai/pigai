		...
		<div class="cont">
			<div class="current-position">
				<span class="font14"> 当前位置：<a href="${pageContext.request.contextPath }/">首页</a> &gt;&gt; 
					<a href="${pageContext.request.contextPath }/course"> 课程</a> &gt;&gt; 作业</span>
			</div>
            ...
            <div class="repair_main">            
				<form id="apply"
					action="${pageContext.request.contextPath}/homework/add"
					method="post">
...
<script>
	function applySubmit() {		
		if (true) {
			...
			postAjaxRequest(basePath()+"/homework/add",
					parm, function(msg) {
						if (msg.status == true) {
							alert(msg.message);
							goAfterTime(basePath() + "/homework/"+$("#courseId").val(),1000);							
						} else {
							alert(msg.message);
						}
