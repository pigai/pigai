...
<%--
/**
 * 全局公用head里js和css导入，其他页面必须调用这个页面
 */
--%>
<meta charset="utf-8" />
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/skins/default.css" />
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/util.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/js/jquery.artDialog.source.js?skin=default"></script> 
