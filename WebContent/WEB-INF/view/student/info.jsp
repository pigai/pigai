		...
		<div class="cont">
			<div class="current-position">
				<span class="font14"> 当前位置：<a href="${pageContext.request.contextPath }/">首页</a> &gt;&gt; 
					<a href="${pageContext.request.contextPath }/student/course">个人信息（快去改我的链接不对哒）</a></span>
            ...
            <div class="repair_main">
					...
					<table border="0" cellpadding="3" cellspacing="3" style="margin: 0 auto;margin-top:100px;"> 
				        <tr> 
				            ...
				            <td> 
				                <input id="studentNo" type="text" size="20" style="border-style:none" value="${student.studentNo}" /> 
				            </td> 
				        </tr> 
				        <tr> 
				            <td style="text-align: right; padding: 10px"> 
