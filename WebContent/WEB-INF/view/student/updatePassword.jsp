		...
		<div class="cont">
			<div class="current-position">
				<span class="font14"> 当前位置：<a href="${pageContext.request.contextPath }/">首页</a> &gt;&gt; 
					<a href="${pageContext.request.contextPath }/student/course">修改密码（快去改我的链接不对哒）</a></span>
			...
			<div class="repair_con mt10">
				<div class="repair_title">
					<ul>
					    <li  class="current cur" onclick="go('${pageContext.request.contextPath }/student/course/detail/${courseId }')">修改密码</li>															
					</ul>		
					<span class="back">
